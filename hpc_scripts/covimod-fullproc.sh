...
#PBS -l select=1:ncpus=10:ompthreads=1:mem=150gb

REPO_PATH=/rds/general/user/jt1319/home/bayes-rate-consistency
WAVES=5
MODEL="hsgp-eq-lrd-none"
HSGP_C=1.5
HSGP_M1=30
HSGP_M2=30
...
MODEL=${MODEL}-${WAVES}
Rscript $REPO_PATH/scripts/postprocess.R --model $MODEL --model $MODEL --mixing $MIXING --ppc $PPC --plot $PLOT
